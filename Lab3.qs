...
namespace QSharpExercises.Lab3 {
    ...
    operation Exercise1 (register : Qubit[]) : Unit {
        ...
        // Q# built-in function to apply a gate to every qubit in an array...
    ...
    operation Exercise5 (register : Qubit[]) : Unit {
        ...
        X(register[2]);
         ...
         // or, with an extra qubit...
         // this lets you focus on the control, ignoring the target state
         // use ancilla = Qubit();
    ...
    operation Exercise6 (register : Qubit[]) : Unit {
        ...
        // controlled gates require the control to be put in as an array
